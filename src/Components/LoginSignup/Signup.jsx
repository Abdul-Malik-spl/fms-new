...
export const Signup = () => {
  ...
  let formData = [
...

    {
      ...
      errMsg: !userData.userConfirmPass
        ? "Enter confirm Password"
        : userData.userPass &&
          userData.userConfirmPass &&
          userData.userPass !== userData.userConfirmPass
  ...
  return (
    <div
      className="d-flex align-items-center justify-content-center h-100 md-h-75 "
      ...
      <form className="border adminSignForm">
        ...
        <div className="roleSelectSec signFormRowCon">
          ...
          <select
            ...
            name="selectRole"
            value={userData.selectRole}
            onChange={inpValueGet}
          >
        ...
        <div className="w-100 mt-4">
          <button className="btn btn-primary w-100" onClick={dataSubmit}>
            Sign Up
          </button>
        </div>
      </form>
